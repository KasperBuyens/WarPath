...
export const BATTLES: Record<string, Battle> = {
  ...
  horseBaron: {
    ...
    victoryLore: 'In a swift battle, all the soldiers and guards who accompanied the Baron were slaughtered. \n\nTheir blood still drips from the undergrowth while the noble leader of horse knights is bound and taken.',
    victoryImage: baronAmbushVictoryImage,
  },
  castle: {
    title: "Siege the King's Castle!",
    lore: 'After hearing of the defeat of his allies, King Edward the Valiant cowers behind the walls of his fortress. \n\nA mighty army sits between the Orcs and the end of their conquest. The castle is well defended, but there is no doubt that it won\'t be enough to hold for long. Once those gates fall, the Human Lands shall fall with them.',
    image: castleImage,
    meleeCost: 100,
    rangeCost: 100,
    wonField: 'castleWon',
